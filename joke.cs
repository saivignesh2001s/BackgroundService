...
namespace Service
{
    public class jokepunches
    {
        public string  getjoke()
        {
           var k= jokes.ElementAt(
                Random.Shared.Next( 0, jokes.Count() ) );
            return $"{k.setup}{Environment.NewLine}{k.set}";
        }
        private readonly HashSet<Joke> jokes = new()
       {
    ...
    readonly record struct Joke(string setup,string set);
